...
![Screenshot of the upload page showing a file picker and upload button](screenshots/index.png)
**Upload page**

![Screenshot of the select target page with a dropdown](screenshots/select-target.png)
**Select target page**

![Screenshot of the results page with dataset name, target column, problem type, model score with the best one highlighted](screenshots/results.png)
**Results page**
...
5. **Two models are trained and compared**, chosen automatically based on the detected problem type:
   ...
   - 5 fold Cross Validation is used to select the best model (replacing train_test_split())
